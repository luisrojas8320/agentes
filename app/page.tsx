...
import { Link, Mic, Wand2, ScanSearch } from "lucide-react";
...
export default function HomePage() {
  const { messages, input, handleInputChange, handleSubmit, isLoading } = useChat({
    // SOLUCIÓN: Apuntar a la ruta API correcta.
    api: "/api/chat",
  });
      ...
      <main className="flex-1 flex flex-col h-screen">
        ...
        <div className="p-4 md:p-8 border-t border-gray-700">
          <div className="w-full max-w-3xl mx-auto">
            ...
            <form onSubmit={customHandleSubmit} className="w-full bg-[#111111] border border-gray-700 rounded-lg p-4">
              <Textarea
                ...
                onKeyDown={(e) => {
                  if (e.key === 'Enter' && !e.shiftKey) {
                    e.preventDefault();
                    // Crea un evento de formulario sintético para el envío.
                    const form = e.currentTarget.closest('form');
                    if(form) {
                      customHandleSubmit(new Event('submit', { cancelable: true, bubbles: true }) as any);
                    }
                  }
                }}
              />
              <div className="flex justify-between items-center mt-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Button type="submit" disabled={isLoading || !input.trim()} className="bg-blue-600 hover:bg-blue-700 disabled:opacity-50">
